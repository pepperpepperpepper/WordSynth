...
class TestTTSMaryttsSyllabizers(unittest.TestCase, SyllabizersTests):
    ...
    def test_syllabizer_learning(self):
      super(TestTTSMaryttsSyllabizers, self).test_syllabizer_learning(['frEnd', 'SIp'])
    def test_syllabizer_marytts(self):
      super(TestTTSMaryttsSyllabizers, self).test_syllabizer_marytts(['frEn','dSIp'])
    def test_syllabizer_trouvain(self):
      super(TestTTSMaryttsSyllabizers, self).test_syllabizer_trouvain(['frE', 'ndSIp'])
...
class TestTTSOSXttsSyllabizers(unittest.TestCase, SyllabizersTests):
    ...
    def test_syllabizer_learning(self):
      super(TestTTSOSXttsSyllabizers, self).test_syllabizer_learning( ['_fr1EHnd', 'SIHp.'] )
    def test_syllabizer_marytts(self):
      super(TestTTSOSXttsSyllabizers, self).test_syllabizer_marytts(['frEn','dSIp'])
    def test_syllabizer_trouvain(self):
      super(TestTTSOSXttsSyllabizers, self).test_syllabizer_trouvain(['_fr1EH', 'ndSIHp.'])
