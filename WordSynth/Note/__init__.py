...
class Note(object):
    ...
    def __str__(self):
        return "<Note Object:  pitch:{} hz, duration:{}>".format(
    ...
    def from_music21():
        ...
        # (num / (tempo * 1/60)) * 1000
        # music21 note.duration * tempo (
#            from music21.tempo tempoinstance.number * \
#            durationinstance.quarterLength
        # BPM -> BPS (FIRST CONVERT BPM to BEATS PER MILLISECOND )
        # divide tempo by 6000
