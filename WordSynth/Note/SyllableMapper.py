...
class NoteSyllableMapper(object):
  ...
  def _map_notes_to_vowel(self,characters, vowel, notes):
    ...
    """returns vowel_notes...copies of the vowel character if necessary, in an array"""
  ...
  def map_notes_to_syllable(self, syllable, notes): 
    ...
    characters = map(lambda x: self._map_notes_to_vowel(syllable.characters(), x, notes) if x.is_vowel() else x, syllable.characters())
